...
owner =["u76148c21fcedca13240862b0af7ff212"]
admin = ["u76148c21fcedca13240862b0af7ff212"]
wait = {
    'contact':False,
    'autoJoin':True,
...
def bot(op):
            ...
            if cl.getGroup(op.param1).preventJoinByTicket == False:
              if op.param2 in Bots:
                ...
                pass
              	...
              	try:
                	cl.sendText(op.param1,cl.getContact(op.param2).displayName + "Jangan Buka Kode QR")
                	cl.kickoutFromGroup(op.param1,[op.param2])
                	X = cl.getGroup(op.param1)
                	X.preventJoinByTicket = True
                	cl.updateGroup(X)
                	cl.sendText(op.param1,cl.getContact(op.param2).displayName + "\n" + "Kami Masukan Kedalam Blacklist")
                	wait["blacklist"][op.param2] = True
                	f=codecs.open('st2__b.json','w','utf-8')
                	json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                except:
                	random.choice(KAC).sendText(op.param1,random.choice(KAC).getContact(op.param2).displayName + "Jangan Buka Kode QR")
          ...
          if wait["Protectjoin"] == True:
            if op.param2 not in Bots:
              if op.param2 in Bots:
                ...
                try:
                  random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
                  cl.sendText(op.param1, "Protect Join nye On\nMatiin dulu kalo mau Ada yang Gabung\nJoinn on/off")
                except:
                  random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
                  cl.sendText(op.param1, "Protect Join nye On\nMatiin dulu kalo mau Ada yang Gabung\nJoinn on/off")
        #------Joined User Kick start------#
    ...
    #-----------------=Selesai=------------------
              ...
              #if msg.from_ in admin:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'ucf9951cca797709b8a2bca18941740f2',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '5'}
                msg.text = None
            ...
            ##if msg.from_ in admin:
                ...
                ##cl.sendMessage(msg)
            elif msg.text in ["Buka qr","Open qr","Buka"]:
              ##if msg.from_ in admin:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Sap buka qr","Sap open qr"]:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Pian buka qr","Pian open qr"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["Tutup qr","Close","Tutup"]:
              #if msg.from_ in admin:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = True
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
              ...
              ##if msg.from_ in admin:
            ...
            elif msg.text in ["Wkwkwk","Wkwk","wkwkwk","wkwk"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "100",
                ...
                ki2.sendMessage(msg)
                ki3.sendMessage(msg)
            elif msg.text in ["Hehehe","Hehe","hehehe","hehe"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "10",
                ...
                ki.sendMessage(msg)
                ki2.sendMessage(msg)
            elif msg.text in ["Puku puku paw paw"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "101",
            ...
            elif msg.text in ["Bot 1 rename "]:
              #if msg.from_ in admin:
                string = msg.text.replace("Bot 1 rename ","")
                if len(string.decode('utf-8')) <= 20:
                    profile = ki.getProfile()
                    profile.displayName = string
                    ki.updateProfile(profile)
                    ki.sendText(msg.to,"name " + string + " done")
            elif msg.text in ["Bot 2 rename "]:
              #if msg.from_ in admin:
                string = msg.text.replace("Bot 2 rename ","")
                if len(string.decode('utf-8')) <= 20:
...
#-------------------- Protect Mode ------------
                ...
                if wait["Protectjoin"] == False:
                    ...
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Udah Matekk")
                    else:
                        cl.sendText(msg.to,"Udah Matekk")
...
#---------------------Sc invite owner ke group------
                ...
                if gid == "":
                  ...
                  try:
                    ...
                    ki.sendText(msg.to,"Mungkin gua gak di dalam grup itu")
#--------===---====--------------
        ...
        #-------------Fungsi Jam Update Finish-------------------#
                ...
                #print wait2
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "||Di Read Oleh||%s\n||By : Savian V2||\n\n>Pelaku<\n%s-=Sider=-" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        cl.sendText(msg.to, "Ketik Sider terlebih dulu\nBaru Ketik Lokit")
#-----------------------------------------------

#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Mash0k"]:
    ...
    #-------------------------------------------------#
            ...
            elif msg.text in ["Like temen"]:
              #if msg.from_ in admin:
                print "[Command]Like executed"
                cl.sendText(msg.to,"We're already like post your friend")
                try:
                  autolike()
                except:
                  pass
                ...
                if targets == []:
                  ...
                  for target in targets:
                    try:
                      ...
                      print e
        #-----------------------------------------
            elif "Bansat" in msg.text:
              if msg.from_ in owner:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("Bansat","")
                    gs = cl.getGroup(msg.to)
                    gs = ki.getGroup(msg.to)
                    gs = ki2.getGroup(msg.to)
                    cl.sendText(msg.to,"Hihihi")
                    cl.sendText(msg.to,"Permisi, mau beres-beres dulu")
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': 'u76148c21fcedca13240862b0af7ff212'}
                    cl.sendMessage(msg)
                    cl.sendText(msg.to,"Nitip jejak")
                    targets = []
                    for g in gs.members:
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Bot out","Kuarrr"]:
              #if msg.from_ in admin:
                gid = cl.getGroupIdsJoined()
                ...
                for i in gid:
                  ...
                  ki2.leaveGroup(i)
                if wait["lang"] == "JP":
                  cl.sendText(msg.to,"Semua Telah Sukses Keluar")
                else:
...
#------------------------End---------------------
 ...
 #-----------------End-----------
                ...
                ki.sendText(msg.to,"Hi too")
                ki2.sendText(msg.to,"Hi too")
                #ki3.sendText(msg.to,"Hi too")

#-----------------------------------------------
            elif msg.text in ["Welcome"]:
                ki.sendText(msg.to,"Selamat datang!")
#-----------------------------------------------
            elif msg.text in ["Puku Puku"]:
                ki.sendText(msg.to,"Paw Paw 􀜁􀅔Har Har􏿿")
                ki2.sendText(msg.to,"Paw Paw 􀜁􀅔Har Har􏿿")
                #ki3.sendText(msg.to,"Paw Paw 􀜁􀅔Har Har􏿿")
#-----------------------------------------------

       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["Duarrr"]:
              #if msg.from_ in admin:
                cl.sendText(msg.to,"1")
                ki.sendText(msg.to,"2")
                ki2.sendText(msg.to,"3")
                cl.sendText(msg.to,"Siap Protect Group")
      ...
      #-------------Fungsi Balesan Respon Start---------------------#
            ...
            elif msg.text in ["woyy","woi","woy","woii","woyyy"]:
                ki.sendText(msg.to,"Ada apa? 􀨁􀅴questioning􏿿")
...
#---------------------
        if op.type == 17:
          ...
          #cl.choice(KAC).sendText(op.param1,"Budayakan Baca Note!!\nSemoga Betah.")
          #print "JOINED"
#------------------------
        if op.type == 59:
            print op
